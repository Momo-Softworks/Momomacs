...
(setq momo/packages-alist (momo/defun-packages '((elfeed . "social/elfeed")
						 ...
						 (visual-fill-column . "file-handling/visual-fill-column")
						 (shrface . "file-handling/shrface")
						 (corfu . "completions/corfu")
						 (dirvish . "file-handling/dirvish")
						 (dashboard . "UI/dashboard")
						 (racket . "programming/racket")
						 (geiser . "programming/geiser")
						 (arei . "programming/arei")
						 (kawa . "programming/kawa")
						 (projectile . "project-management/projectile")
						 (magit . "project-management/magit")
						 (envrc . "project-management/envrc")
						 ...
						 (parinfer-rust . "programming/parinfer-rust")
						 (jinx . "programming/jinx")
